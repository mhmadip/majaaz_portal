...
/* ═══════════ AUTH ═══════════ */
#view-auth{align-items:center;justify-content:center;min-height:100vh;padding:40px 20px;position:relative;}
#view-auth.view.active{display:flex;}
...
<div id="view-auth" class="view">
  ...
  <form id="login-form" class="auth-card" style="animation:mIn .3s ease;" autocomplete="on">
    ...
    <div class="field"><label class="field-label" data-i18n="password">كلمة المرور</label><input class="input" type="password" id="login-pass" name="password" autocomplete="current-password" placeholder="••••••••"></div>
    <button type="submit" class="btn btn-primary btn-lg btn-full" id="btn-login" data-i18n="login_btn">دخول ←</button>
...
function openEditProject(pid){
  ...
  stageImgs=(p.images||[]).map(function(im,i){return {dataUrl:im.dataUrl,name:im.filename||t('image')+' '+(i+1),desc:im.desc||''};});
  renderImgItems();
  ...
  members.forEach(function(m){
    ...
    tr.innerHTML='<td style="font-weight:600;">'+m.name+'</td>'
      ...
      +'<td><div style="display:flex;align-items:center;gap:6px;">'
        +'<span style="font-family:\'IBM Plex Mono\',monospace;font-size:11px;direction:ltr;color:var(--cyan);background:var(--s3);padding:3px 8px;border-radius:4px;border:1px solid var(--b2);max-width:320px;overflow-wrap:anywhere;">'+(m.password||'')+'</span>'
...
g('login-form').onsubmit=function(e){e.preventDefault();doLogin();return false;};
